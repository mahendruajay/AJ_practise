...
Given an array of ascending three-digit integers nums representing a binary tree with a depth smaller than 5, return
...
public class PathSum4 {
    ...
    public static void main(String[] args) {
        int[] input = {113, 215, 221, 316, 327, 338, 339};

        PathSum4 pathSum4 = new PathSum4();
        System.out.println("Result: " + pathSum4.pathSum(input));
    }
